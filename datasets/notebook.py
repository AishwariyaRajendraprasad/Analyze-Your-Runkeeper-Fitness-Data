...
runs_subset_2013_2018 = df_run.loc['20181231':'20121231']
...
runs_subset_2015_2018 = df_run.loc['20181231':'20141231']
...
# Prepare data
df_run_dist_wkly = df_run.sort_index()['20130101':'20181231']['Distance (km)']                     .resample('W').bfill()
